          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative">
            ...
            <div className="lg:col-span-7 space-y-8 relative">
              <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight">
                ...
                <div>
                  <span className="text-primary">Your Peak</span>
                </div>
                <div className="pt-2">
                  <span className="text-foreground">With Flex</span>
                </div>
                <div className="pt-2">
              ...
              <p className="text-xl text-muted-foreground w-2/3">
                Mulailah dengan Almaflex AI assistent dan dapatkan rencana diet serta rutinitas 
                olahraga yang telah dipersonalisasi untuk Anda.
              </p>
