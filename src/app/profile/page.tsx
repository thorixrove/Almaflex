          ...
          <div className="relative backdrop-blur-sm border border-border p-6">
            ...
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-xl font-bold tracking-tight">
                <span className="text-primary">Rencana</span>{" "}
                <span className="text-foreground">Fitness Anda</span>
              </h2>
                          ...
                          <AccordionTrigger className="px-4 py-3 hover:no-underline hover:bg-primary/10 font-mono">
                            <div className="flex justify-between w-full items-center">
                              ...
                              <div className="text-xs text-muted-foreground">
                                {exerciseDay.routine.length} EXERCISES
                              </div>
                            </div>
                          </AccordionTrigger>
                           ...
                           <AccordionContent className="pb-4 px-4">
                            <div className="space-y-3 mt-2">
                              {exerciseDay.routine.map((routine, routineIndex) => (
                                    <div
                                  key={routineIndex}
