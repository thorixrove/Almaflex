  ...
  return (
    <div className="relative backdrop-blur-sm border border-border rounded-lg p-10 text-center">
        ...
        <h2 className="text-2xl font-bold mb-4 font-mono">
            <span className="text-primary">Tidak</span> ada rencana fitness
        </h2>
        <p className="text-muted-foreground mb-6 max-w-md mx-auto">
            Mulai dengan membuat personalsasi fitness dan rencana diet yang disesuaikan dengan spesifikasi tujuan anda
        </p>
        <Button
        size="lg"
        asChild
